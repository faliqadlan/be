...
func (m *mockSuccess) GetProfile(patient_uid string) (patient.Profile, error) {
	return patient.Profile{}, nil
}

func (m *mockSuccess) GetRecords(patient_uid string) (patient.Records, error) {
	return patient.Records{}, nil
}

func (m *mockSuccess) GetHistories(patient_uid string) (patient.Histories, error) {
	return patient.Histories{}, nil
}

func (m *mockSuccess) GetAppointMent(Patient_uid string) (patient.Apppoinment, error) {
	return patient.Apppoinment{}, nil
}
...
func (m *mockFail) GetRecords(patient_uid string) (patient.Records, error) {
	return patient.Records{}, errors.New("")
}

func (m *mockFail) GetHistories(patient_uid string) (patient.Histories, error) {
	return patient.Histories{}, errors.New("")
}

func (m *mockFail) GetAppointMent(Patient_uid string) (patient.Apppoinment, error) {
	return patient.Apppoinment{}, errors.New("")
}
...
func TestGetRecord(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		var controller = New(&mockSuccess{}, &session.Session{})
		if err := middleware.JWT([]byte(configs.JWT_SECRET))(controller.GetRecords())(context); err != nil {
			log.Fatal(err)
			return
		}
...
func TestGetHistories(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		var controller = New(&mockSuccess{}, &session.Session{})
		if err := middleware.JWT([]byte(configs.JWT_SECRET))(controller.GetHistories())(context); err != nil {
			log.Fatal(err)
			return
		}
...
func TestGetAppointment(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		var controller = New(&mockSuccess{}, &session.Session{})
		if err := middleware.JWT([]byte(configs.JWT_SECRET))(controller.GetAppointMent())(context); err != nil {
			log.Fatal(err)
			return
		}
